                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="about-thumbnail">
                            <div class="thumbnail">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/about-01.png" al'?>t="About Us">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row--20">
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/shape-01.png" al'?>t="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/shape-02.png" al'?>t="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/shape-03.png" al'?>t="Shape">
                            </div>
                            <div class="content">
        ...
        <div class="axil-about-area about-style-2">
            <div class="container">
                <div class="row align-items-center mb--80 mb_sm--60">
                    <div class="col-lg-5">
                        <div class="about-thumbnail">
                            <img src="<?= ROOT_URL . 'views/client/assets/images/about/about-02.png" al'?>t="about">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="about-content content-right">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 order-lg-2">
                        <div class="about-thumbnail">
                            <img src="<?= ROOT_URL . 'views/client/assets/images/about/about-03.png" al'?>t="about">
                        </div>
                    </div>
