                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                    src="<?= ROOT_URL . 'views/client/assets/images/product/jewellery/'?>product-10.png" alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href="wishlist.html"><i
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                    src="<?= ROOT_URL . 'views/client/assets/images/product/jewellery/'?>product-11.png" alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href="wishlist.html"><i
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500"
                                    src="<?= ROOT_URL . 'views/client/assets/images/product/jewellery/'?>product-12.png" alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href="wishlist.html"><i
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500"
                                    src="<?= ROOT_URL . 'views/client/assets/images/product/jewellery/'?>product-13.png" alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href="wishlist.html"><i
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                    src="<?= ROOT_URL . 'views/client/assets/images/product/jewellery/'?>product-14.png" alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href="wishlist.html"><i
        ...
        <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-2.png"
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-3.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-4.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-5.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="600" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-6.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-7.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-8.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product" data-sal="zoom-out" data-sal-delay="100" data-sal-duration="500">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-1.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-9.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-10.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-11.png"
                            alt="product categorie">
            ...
            <div class="slick-single-layout">
                <div class="categrie-product">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-12.png"
                            alt="product categorie">
                        <h6 class="cat-title">Pledge Pins</h6>
                    </a>
                </div>
            ...
            <div class="slick-single-layout">
                <div class="categrie-product">
                    <a href="#">
                        <img class="img-fluid" src="<?= ROOT_URL . 'views/client/assets/images/product/categories'?>/jewelry-13.png"
                            alt="product categorie">
                        <h6 class="cat-title">Medallion</h6>
                    </a>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                    <div class="axil-product product-style-one">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                    src="<?= ROOT_URL . 'views/client/assets/images/product/jewellery/'?>product-15.png" alt="Product Images">
                            </a>
                            <div class="label-block label-right">
