...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2024 12:17:53 GMT -->
...
<![endif]-->
    ...
    <main class="main-wrapper">
                ...
                <div class="container">
                    <div class="axil-dashboard-warp">
                        <div class="axil-dashboard-author">
                            <div class="media">
                                <div class="thumbnail">
                                    <img src="assets/images/product/author1.png" alt=<?php echo  $username ?>>
                                </div>
                                <div class="media-body">
                                    <h5 class="title mb-0"><?php echo $username ?></h5>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                        <div class="axil-dashboard-overview">
                                            <div class="welcome-text">Hello <?php echo $username ?> (not <span><?php echo $username ?>?</span> <a href="index.php?act=logout">Log Out</a>)</div>
        ...
        ?>
            ...
            <p class="text-center">Bạn cần đăng nhập <a href="index.php?act=login">Login</a></p>
        <?php endif; ?>
        <!-- End My Account Area  -->
