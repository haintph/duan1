                    ...
                    <div class="col-md-4 col-5">
                        <div class="header-brand">
                            <a href="index.html" class="logo logo-dark">
                                <img src="./giaodien/assets/images/logo/logo.webp" alt="Site Logo">
                            </a>
                            <a href="index.html" class="logo logo-light">
                                <img src="./giaodien/assets/images/logo/logo-light.png" alt="Site Logo">
                            </a>
                        </div>
                    </div>
                        ...
                        <nav class="mainmenu-nav">
                            ...
                            <div class="mobile-nav-brand">
                                <a href="index.html" class="logo">
                                    <img src="./giaodien/assets/images/logo/logo.png" alt="Site Logo">
                                </a>
                            </div>
                            <ul class="mainmenu">
                                <li>
