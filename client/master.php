                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-1.png" alt="Product Images">
                                    </a>
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-2.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-3.png" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-4.png" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-four">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-5.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-6.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-7.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-8.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-9.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-10.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-11.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-12.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-13.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-three">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-14.png" alt="Product Images">
                                    </a>
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            <li class="wishlist"><a href="wishlist.html"><i
                ...
                <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-2.png"
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-3.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-4.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-5.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="600" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-6.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-7.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-8.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="100" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-1.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-9.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-10.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-11.png"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-12.png"
                                    alt="product categorie">
                                <h6 class="cat-title">Pledge Pins</h6>
                            </a>
                        </div>
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="./giaodien/assets/images/product/categories/jewelry-13.png"
                                    alt="product categorie">
                                <h6 class="cat-title">Medallion</h6>
                            </a>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                            <div class="axil-product product-style-one">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500"
                                            src="./giaodien/assets/images/product/jewellery/product-15.png" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
            ...
            <div class="row row-cols-xl-4 row-cols-sm-2 row-cols-1 row--20">
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="./giaodien/assets/images/icons/service1.png" alt="Service">
                        </div>
                        <div class="content">
                ...
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="./giaodien/assets/images/icons/service2.png" alt="Service">
                        </div>
                        <div class="content">
                ...
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="./giaodien/assets/images/icons/service3.png" alt="Service">
                        </div>
                        <div class="content">
                ...
                <div class="col">
                    <div class="service-box service-style-2">
                        <div class="icon">
                            <img src="./giaodien/assets/images/icons/service4.png" alt="Service">
                        </div>
                        <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 order-lg-2">
                                        <div
                                            ...
                                            <div class="thumbnail">
                                                <img src="./giaodien/assets/images/product/product-big-01.png"
                                                    alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                                <div class="product-quick-view position-view">
                                                    <a href="./giaodien/assets/images/product/product-big-01.png"
                                                        class="popup-zoom">
                                            ...
                                            <div class="thumbnail">
                                                <img src="./giaodien/assets/images/product/product-big-02.png"
                                                    alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                                <div class="product-quick-view position-view">
                                                    <a href="./giaodien/assets/images/product/product-big-02.png"
                                                        class="popup-zoom">
                                                        <i class="far fa-search-plus"></i>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="thumbnail">
                                                <img src="./giaodien/assets/images/product/product-big-03.png"
                                                    alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                                <div class="product-quick-view position-view">
                                                    <a href="./giaodien/assets/images/product/product-big-03.png"
                                                        class="popup-zoom">
                                                        <i class="far fa-search-plus"></i>
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-lg-2 order-lg-1">
                                        <div class="product-small-thumb small-thumb-wrapper">
                                            <div class="small-thumb-img">
                                                <img src="./giaodien/assets/images/product/product-thumb/thumb-08.png"
                                                    alt="thumb image">
                                            </div>
                                            <div class="small-thumb-img">
                                                <img src="./giaodien/assets/images/product/product-thumb/thumb-07.png"
                                                    alt="thumb image">
                                            </div>
                                            <div class="small-thumb-img">
                                                <img src="./giaodien/assets/images/product/product-thumb/thumb-09.png"
                                                    alt="thumb image">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="inner">
                                        <div class="product-rating">
                                            <div class="star-rating">
                                                <img src="./giaodien/assets/images/icons/rate.png" alt="Rate Images">
                                            </div>
            ...
            <div class="card-body">
                ...
                <div class="psearch-results">
                    <div class="axil-product-list">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img src="./giaodien/assets/images/product/electric/product-09.png" alt="Yantiti Leather Bags">
                            </a>
                        </div>
                        <div class="product-content">
                            <div class="product-rating">
        ...
        <div class="cart-content-wrap">
            ...
            <div class="cart-body">
                <ul class="cart-item-list">
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product.html"><img src="./giaodien/assets/images/product/electric/product-01.png"
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product-2.html"><img src="./giaodien/assets/images/product/electric/product-02.png"
                                    alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product-3.html"><img src="./giaodien/assets/images/product/electric/product-03.png"
                                    alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
